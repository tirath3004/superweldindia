          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                SuperWeld Sources
                <span className="text-[#8B3A3A]"> Pvt Ltd</span>
              </h1>
...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-superweld-bg">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                {[
                  ...
                  { icon: Package, label: "Products", value: "5000+" },
                  { icon: TrendingUp, label: "Experience", value: "25+ Years" },
                ].map((stat) => (
                  <div
                    key={stat.label}
                    className="bg-white border border-[#EDEDED] rounded-xl p-6 text-center hover:shadow-lg transition-shadow"
                  >
                    <stat.icon className="w-8 h-8 text-[#8B3A3A] mx-auto mb-3" />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { icon: Package, title: "Wide Selection", desc: "5000+ products across multiple categories to meet your needs." },
                ...
                <motion.div
                  ...
                  className="bg-white border border-[#EDEDED] rounded-xl p-6 hover:shadow-lg transition-shadow"
                >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="relative aspect-4/3 rounded-3xl overflow-hidden">
                  <ImageReveal 
                    src="https://images.unsplash.com/photo-1581092795360-fd1ca04f095b?w=800&q=80" 
                    alt="Innovation" 
                    className="absolute inset-0"
                  />
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                <motion.div
                  ...
                  className="flex flex-col items-center text-center p-6 bg-white border border-[#EDEDED] rounded-xl hover:border-[#8B3A3A]/50 hover:shadow-lg transition-all group cursor-pointer"
                >
      ...
      {/* CTA Section */}
      <section className="py-24 lg:py-40 bg-[#F5F5F5]">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
